<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<?php echo $form->textAreaRow($model,'foodDesc',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>

		<?php echo $form->textFieldRow($model,'cakesThumbnail',array('class'=>'span5','maxlength'=>100)); ?>

		<?php echo $form->textAreaRow($model,'cakesDesc',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>

		<?php echo $form->textFieldRow($model,'dessertThumbnail',array('class'=>'span5','maxlength'=>100)); ?>

		<?php echo $form->textAreaRow($model,'dessertDesc',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>
