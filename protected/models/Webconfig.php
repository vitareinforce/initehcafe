...
class Webconfig extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('Title, Facebook, Twitter, Youtube, adminMail, Phone', 'required'),
			array('Title, Phone', 'length', 'max'=>100),
			array('Facebook, Twitter, Youtube, adminMail', 'length', 'max'=>1000),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, Title, Facebook, Twitter, Youtube, adminMail, Phone', 'safe', 'on'=>'search'),
		);
	}
